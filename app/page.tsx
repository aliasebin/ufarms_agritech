            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="flex space-x-4">
                  <a href="#" className="text-gray-100 hover:text-white" aria-label="Facebook">
                  ...
                  <a href="#" className="text-gray-100 hover:text-white" aria-label="Instagram">
                  ...
                  <a href="#" className="text-gray-100 hover:text-white" aria-label="Twitter">
