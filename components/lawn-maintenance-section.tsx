  ...
  return (
    <div>
      <FeatureCard
        ...
        images={[
          {
            src: "/lawn.jpeg?height=600&width=800&text=Lawn+Maintenance+1",
            alt: "Professional lawn installation with premium grass varieties",
          },
          {
            src: "/lawn2.jpeg?height=600&width=800&text=Lawn+Maintenance+1",
            alt: "Professional lawn installation with premium grass varieties",
          },
           {
            src: "/lawn3.jpeg?height=600&width=800&text=Lawn+Maintenance+1",
            alt: "Professional lawn installation with premium grass varieties",
          },
